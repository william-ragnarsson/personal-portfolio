...
export function X({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.65l-5.21-6.82-5.96 6.82H1.68l7.73-8.84L1.56 2.25h6.82l4.71 6.23 5.15-6.23Zm-1.16 17.52h1.83L7.01 4.13H5.05L17.08 19.77Z" />
    </svg>
  );
}
