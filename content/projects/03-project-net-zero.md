...
blurb: "AI agent that refactors legacy code to be greener and more energy efficient."
alt: "Project Net Zero's pipeline diagram: code is split per function, optimized, measured for carbon, and only swapped back in if it is greener and still passes tests"
